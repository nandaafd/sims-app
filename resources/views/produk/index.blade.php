    ...
    <div class="col-9">
        <div class="row">
            <form action="" method="get" class="row row-cols-sm-auto g-1 mb-4">
                <div class="col-3">
                    <input type="text" name="cari-produk" id="" placeholder="cari produk" class="form-control form-control-sm">
                </div>
                <div class="col-3">
                ...
                <div class="col-6"><button type="submit" class="btn btn-danger mx-1 btn-sm">Search</button><button class="btn btn-light btn-sm">Reset</button></div>
            </div>
        </form>
    </div>
    <div class="col-3">
        <a href="" class="btn btn-success btn-sm"><i class="bi bi-filetype-xlsx"></i> Export excel</a>
